...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        ControlPaint.DrawStringDisabled(e.Graphics, "Ownerdraw TabControl", drawFont, BackColor, RectangleF.op_Implicit(r), sf)
        drawFont.Dispose()
        ...
        For index As Integer = 0 To TabCount - 1
            ...
            If SelectedIndex = index Then
                ...
                paintBrush.Color = Color.PaleGreen
            Else
...
'        br = New SolidBrush(Color.PaleGreen)
